...
assert.equal(paperProgress([{ paper_trading: { rule_version: "p2.11_v2", candidate_count: 1, watch_count: 1, executed_count: 0 } }]).remaining_days, 19, "paper progress must count D1 decision days");
